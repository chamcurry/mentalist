...
Post.create([
  ...
  },
  {
    ...
    image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post4.jpg"),filename:"sample-post4.jpg"),menber_id: menbers[1].id
  },
  {
    title: "博多豚骨ラーメン",body: "ラーメン虎龍さんの久留米ラーメンです。",star: 4.5,
    image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post5.jpg"),filename:"sample-post5.jpg"),menber_id: menbers[2].id
  },
  {
    title: "醤油豚骨ラーメン",body: "麺屋福座さんの福座ラーメンです。",star: 4.0,
    image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post6.jpg"),filename:"sample-post6.jpg"),menber_id: menbers[3].id
  },
])

# Post.all.ids.sort.each do |post_id|
#   PostGenre.create([
#   {post_id: post_id}])
# end
